...
const FRAMEWORK_AND_IO = ['@nestjs/*', 'typeorm', '@aws-sdk/*', 'class-validator', 'class-transformer', 'pino', 'pino-*', 'express', 'ioredis'];
          ...
          patterns: [
            {
              ...
              message: 'El dominio debe permanecer puro. Define un puerto y impleméntalo en infrastructure.',
            },
            {
        ...
        'error',
        {
          patterns: [
            ...
            },
            {
              ...
              message: 'Inversión de dependencias: infrastructure implementa puertos, no al revés.',
            },
          ],
        },
      ],
